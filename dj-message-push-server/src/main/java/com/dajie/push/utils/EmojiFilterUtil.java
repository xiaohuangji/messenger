...
public class EmojiFilterUtil {
	...
	private static String convertToString(byte a, byte b, byte c, byte d) {
		String result = "\\:" + (Integer.toHexString(a & 0XFF))
				+ (Integer.toHexString(b & 0XFF))
				+ (Integer.toHexString(c & 0XFF))
				+ (Integer.toHexString(d & 0XFF));
		return result;
	}
	 ...
	 * 
	 * */
	public static String recoverToEmoji(String str)
