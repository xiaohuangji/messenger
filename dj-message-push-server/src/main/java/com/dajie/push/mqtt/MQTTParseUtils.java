...
public class MQTTParseUtils {
    ...
    public static String decodeString(ByteBuf in) throws UnsupportedEncodingException {
        ...
        //int strLen = MQTTParseUtils.readWord(in);
    ...
    public static ByteBuf encodeString(String str) {
        ...
        try {
            ...
            LoggerFactory.getLogger(MQTTParseUtils.class).error(null, ex);
            return null;
        }
        //MQTTParseUtils.writeWord(out, raw.length);
